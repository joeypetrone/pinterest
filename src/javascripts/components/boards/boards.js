...
const boardMaker = (board) => {
  ...
  domString += `<div class="card-header font-weight-bold">${board.name}<button id="delete-${board.id}" class="btn btn-danger delete-board rounded-circle float-right" ><i class="fas fa-trash"></i></button></div>`;
